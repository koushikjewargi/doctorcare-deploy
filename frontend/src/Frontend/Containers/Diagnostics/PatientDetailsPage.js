      ...
      <div className="patient-form">
        ...
        {appointmentData.doctor && (
          <div style={{ 
            ...
            <p style={{ margin: '4px 0', color: '#166534' }}><strong>Doctor:</strong> {appointmentData.doctor}</p>
            <p style={{ margin: '4px 0', color: '#166534' }}><strong>Date:</strong> {appointmentData.date}</p>
            <p style={{ margin: '4px 0', color: '#166534' }}><strong>Time:</strong> {appointmentData.time}</p>
